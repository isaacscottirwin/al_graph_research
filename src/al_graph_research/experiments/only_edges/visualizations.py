...
#     [result_LL, result_ZLL, result_NLL],
#     "accuracy_history",
#     ["LL", "ZLL", "NLL"],
...
#     "kappa_history",
#     ["LL", "ZLL", "NLL"],
#     title="Kappa over steps"
# )
def animate_embedding_history(run_state, true_labels, save_path=None):
    ...
    plt.close(fig)   # important for notebooks
    return anim
...
def animate_embedding_true_vs_pred(run_state, true_labels, save_path=None):
    embeddings = run_state.embedding_history
...
# animate_embedding_history(run0, dataset.labels)
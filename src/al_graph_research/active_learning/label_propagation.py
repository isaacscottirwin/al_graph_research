...
class LabelPropagation:
    @staticmethod
    def labels_propagation(A, y, empty_val, model_type="laplace", **model_kwargs):
        """
        ...
        model = Model(model_type=model_type, W=A, class_priors=class_priors, **model_kwargs)
        return model.fit(train_indices, train_labels)
    ...
    @staticmethod
    def classifier_accuracy_vec(predicted_labels, true_labels, method="best_flip", unlabeled_mask=None, labels=None, empty_val=None):
        """
    ...
    @staticmethod
    def check_model_lists_unique(lists):
        """
